...
vim.keymap.set({ 'n', 'v' }, '<leader>se', sql.save_query, { desc = "Run SQL query → save CSV to ~/Repos/saved queries" })
...
vim.keymap.set('n', '<leader>sE', sql.save_last_result, { desc = "Save last SQL result to ~/Repos/saved queries" })
